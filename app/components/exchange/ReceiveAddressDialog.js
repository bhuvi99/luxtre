...
export default class ReceiveAddressDialog extends Component<Props> {
  ...
  render() {
    ...
    const { coinName, walletAddress, onCopyAddress, error, onCancel, children } = this.props;
    ...
    return (
      ...
      >
        {walletAddress != '' ? (
          ...
          <div className={styles.info}>Please login first to get a QR Code for your address!</div>
        )}
