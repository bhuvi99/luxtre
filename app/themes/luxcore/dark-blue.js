...
export default {
  ...
  '--theme-lux-redemption-headline-color': '#e9f4fe',
  '--theme-lux-redemption-instructions-color': '#e9f4fe',
  ...
  '--theme-lux-redemption-success-overlay-message-color': '#e9f4fe',
  '--theme-lux-redemption-success-overlay-button-text-color': '#e9f4fe',
  '--theme-lux-redemption-success-overlay-button-text-color-hover': '#263345',
  '--theme-lux-redemption-success-overlay-button-background-color-hover': '#e9f4fe',
  ...
  '--theme-nav-item-text-gradient-1': '#263345',
  '--theme-nav-item-text-gradient-2': '#506577',
  ...
  '--theme-icon-lux-summary-wallet-amount-symbol-color': '#e9f4fe',
  '--theme-icon-lux-summary-wallet-pending-confirmation-symbol-color': '#e9f4fe',
  ...
  '--theme-icon-transactions-lux-symbol-color': '#e9f4fe',
